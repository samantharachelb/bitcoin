...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the expositio repository."
  exit 1
fi
...
# See https://github.com/expositio/expositio/issues/16064
...
echo 'When compiling expositiod, run `./configure` in the following way:'
echo
