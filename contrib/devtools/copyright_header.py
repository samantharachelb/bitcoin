...
Arguments:
    <base_directory> - The base directory of a expositio source code repository.
...
Arguments:
    <file> - A source file in the expositio repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Expositio
