# Bootstrappable Expositio Core Builds

This directory contains the files necessary to perform bootstrappable Expositio
Core builds.
...
- 24GB of free disk space on the partition that the Expositio Core git repository
  resides in
...
For a Expositio Core depends development environment, simply invoke
...
From the top of a clean Expositio Core repository:
...
To use dongcarl's substitute server for Expositio Core builds after having
