...
// expositio includes.
#include <..\src\script\expositioconsensus.h>
...
int main()
{
    std::cout << "expositioconsensus version: " << expositioconsensus_version() << std::endl;
    ...
    auto op0Result = expositioconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, expositioconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
