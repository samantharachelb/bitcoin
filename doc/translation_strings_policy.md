...
This document provides guidelines for internationalization of the Expositio Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `expositio_en.ts` remains unchanged.
