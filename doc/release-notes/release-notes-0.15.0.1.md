Expositio Core version *0.15.0.1* is now available from:

  <https://expositio.org/bin/expositio-core-0.15.0.1/>

and

  <https://expositiocore.org/bin/expositio-core-0.15.0.1/>
