Expositio version 0.4.1 is now available for download at:
http://sourceforge.net/projects/expositio/files/Expositio/expositio-0.4.1/
...
If you have a previously encrypted wallet.dat, the first time you run wxexpositio or expositiod the wallet will be rewritten, Expositio will
...
wxExpositio: new address visible on main window
