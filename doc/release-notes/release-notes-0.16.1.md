Expositio Core version 0.16.1 is now available from:

  <https://expositiocore.org/bin/expositio-core-0.16.1/>
...
- #12843 `df38b13` Test starting expositiod with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure expositiod processes are cleaned up when tests end (sdaftuar)
