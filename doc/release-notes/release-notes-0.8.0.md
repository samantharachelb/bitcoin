Expositio-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/expositio/files/Expositio/expositio-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Expositio
...
New/changed settings (command-line or expositio.conf file)
--------------------------------------------------------
