Expositio Core version *0.15.2* is now available from:

  <https://expositiocore.org/bin/expositio-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in expositio-tx (TheBlueMatt)
