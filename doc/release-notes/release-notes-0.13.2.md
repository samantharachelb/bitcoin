Expositio Core version 0.13.2 is now available from:

  <https://expositio.org/bin/expositio-core-0.13.2/>
...
- #8908 `4a974b2` Update expositio-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow expositio-tx to create v2 transactions (btcdrak)
