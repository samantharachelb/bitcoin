Expositio version 0.5.4 is now available for download at:
http://sourceforge.net/projects/expositio/files/Expositio/expositio-0.5.4/
...
http://gitorious.org/expositio/expositiod-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Expositio-Qt notifications under Growl 1.3.
Increase required age of Expositio-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxExpositio properly when installing Expositio-Qt over it. (Windows)
