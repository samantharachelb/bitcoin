Expositio Core version 0.10.4 is now available from:

  <https://expositio.org/bin/expositio-core-0.10.4/>
...
- #6953 `43c2789` Split expositio-tx into its own package
- #6953 `dfe0d4d` Include expositio-tx binary on Debian/Ubuntu
