Expositio Core version 0.9.4 is now available from:

  https://expositio.org/bin/0.9.4/
...
this update is incompatible with the Expositio system and could lead to consensus
forks.

Expositio Core released binaries from https://expositio.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~expositio/+archive/ubuntu/expositio
- A third-party or self-compiled Expositio Core

upgrade to Expositio Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
