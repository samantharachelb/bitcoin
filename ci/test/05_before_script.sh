...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Expositio
else
  DOCKER_EXEC echo \> \$HOME/.expositio
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/expositio/expositio/pull/18288#discussion_r433189350 for
  # details.
