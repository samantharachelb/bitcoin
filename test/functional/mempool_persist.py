...
By default, expositiod will dump mempool on shutdown and
...
class MempoolPersistTest(ExpositioTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent expositiod from writing mempool.dat to disk. Verify that `savemempool` fails")
