...
class P2PPermissionsTests(ExpositioTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].expositioconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].expositioconf, 'w', encoding="utf8") as f:
            f.write(newText)
