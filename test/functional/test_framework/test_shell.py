...
class TestShell:
    """Wrapper Class for ExpositioTestFramework.

    The TestShell class extends the ExpositioTestFramework
    ...
    class __TestShell(ExpositioTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by ExpositioTestFramework child class.
            self.num_nodes = 1
