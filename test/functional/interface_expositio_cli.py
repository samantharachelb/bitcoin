...
class TestExpositioCli(ExpositioTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `expositio-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and expositio-cli getwalletinfo return expected wallet info")
            ...
            # Test expositio-cli -generate with -rpcwallet in multiwallet mode.
