...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ExpositioTestFramework
    pass


class ExampleTest(ExpositioTestFramework):
    # Each functional test is a subclass of the ExpositioTestFramework class.
    ...
    def custom_method(self):
        ...
        ExpositioTestFramework class so other tests can use it."""
