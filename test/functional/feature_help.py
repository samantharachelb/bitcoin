...
"""Verify that starting expositio with -h works as expected."""

from test_framework.test_framework import ExpositioTestFramework
from test_framework.util import assert_equal

class HelpTest(ExpositioTestFramework):
    ...
    def run_test(self):
        self.log.info("Start expositio with -h for help text")
        ...
        self.log.info("Start expositio with -version for version information")
        ...
        self.log.info("Start expositiod with -fakearg to make sure it does not start")
