...
#ifndef EXPOSITIO_TEST_SCRIPTNUM10_H
#define EXPOSITIO_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Expositio Core 0.10.0, for cross-comparison.
 */
public:
