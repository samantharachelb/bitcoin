...
{
    const char* pszTimestamp = "2021-05-13 CTVNews: Loonie reaches highest level since 2015";
    const CScript genesisOutputScript = CScript() << ParseHex("04c2cdcb34106c96eff6e71d43e293fd798e28488f60c2984cd3cd7636f39fa4047db6cf26e0bcd7bbbc32fc7c2413f67951e8eecc00b75dcbfd368402f36189ee") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nSubsidyHalvingInterval = 499515245;
        ...
        genesis = CreateGenesisBlock(1620912120, 545259519, 0x00000000, 1, 1000000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x235cf0b27dfc006a55b7137490fa81f903e63c50ef52a0f9c4dc92e8ee42ec28"));
        assert(genesis.hashMerkleRoot == uint256S("0x5936a0782566db7ffceb948c890004f57d51f6ef30ba0db2b8e5f23a87151786"));
        ...
        // vSeeds.emplace_back("seed.expositio.sipa.be"); // Pieter Wuille, only supports x1, x5, x9, and xd
        // vSeeds.emplace_back("dnsseed.bluematt.me"); // Matt Corallo, only supports x9
        // vSeeds.emplace_back("dnsseed.expositio.dashjr.org"); // Luke Dashjr
        // vSeeds.emplace_back("seed.expositiostats.com"); // Christian Decker, supports x1 - xf
        // vSeeds.emplace_back("seed.expositio.jonasschnelli.ch"); // Jonas Schnelli, only supports x1, x5, x9, and xd
        // vSeeds.emplace_back("seed.btc.petertodd.org"); // Peter Todd, only supports x1, x5, x9, and xd
        // vSeeds.emplace_back("seed.expositio.sprovoost.nl"); // Sjors Provoost
        // vSeeds.emplace_back("dnsseed.emzy.de"); // Stephan Oeste
        // vSeeds.emplace_back("seed.expositio.wiz.biz"); // Jason Maurice
...
public:
    CTestNetParams() {
        ...
        // vSeeds.emplace_back("testnet-seed.expositio.jonasschnelli.ch");
        // vSeeds.emplace_back("seed.tbtc.petertodd.org");
        // vSeeds.emplace_back("seed.testnet.expositio.sprovoost.nl");
