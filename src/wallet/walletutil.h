...
#ifndef EXPOSITIO_WALLET_WALLETUTIL_H
#define EXPOSITIO_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! expositio from opening the wallet, thinking it was newly created, and
...
#endif // EXPOSITIO_WALLET_WALLETUTIL_H
