...
#ifndef EXPOSITIO_WALLET_SCRIPTPUBKEYMAN_H
#define EXPOSITIO_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Expositio Core wallet was originally a collection of unrelated private
...
#endif // EXPOSITIO_WALLET_SCRIPTPUBKEYMAN_H
