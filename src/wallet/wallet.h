...
#ifndef EXPOSITIO_WALLET_WALLET_H
#define EXPOSITIO_WALLET_WALLET_H
...
public:
     ...
     * on this expositio node, and set to 0 for transactions that were created
...
#endif // EXPOSITIO_WALLET_WALLET_H
