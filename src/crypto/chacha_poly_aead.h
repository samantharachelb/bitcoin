...
#ifndef EXPOSITIO_CRYPTO_CHACHA_POLY_AEAD_H
#define EXPOSITIO_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@expositio.
 *
 ...
 *
 * The chacha20-poly1305@expositio combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@expositio cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@expositio are relatively fast in
...
#endif // EXPOSITIO_CRYPTO_CHACHA_POLY_AEAD_H
