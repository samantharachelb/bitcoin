...
#ifndef EXPOSITIO_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define EXPOSITIO_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // EXPOSITIO_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
