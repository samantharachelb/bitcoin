    ...
    platformStyle(_platformStyle)
{
    ...
    // normal expositio address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying expositio address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &ExpositioAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
