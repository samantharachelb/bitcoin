...
#ifndef EXPOSITIO_QT_GUIUTIL_H
#define EXPOSITIO_QT_GUIUTIL_H
...
/** Utility functions used by the Expositio Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "expositio:" URI into recipient object, return true on successful parsing
