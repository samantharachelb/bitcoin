    ...
    mapper(nullptr)
{
    ...
    ui->expositioAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->expositioAtStartup);
    ...
    ui->expositioAtStartup->setToolTip(ui->expositioAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->expositioAtStartup->setText(ui->expositioAtStartup->text().arg(PACKAGE_NAME));

    ui->openExpositioConfButton->setToolTip(ui->openExpositioConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new ExpositioUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->expositioAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openExpositioConfButton_clicked()
{
