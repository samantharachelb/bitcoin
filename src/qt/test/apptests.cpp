...
//! Entry point for ExpositioApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &ExpositioApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for ExpositioGUI tests.
void AppTests::guiTests(ExpositioGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &ExpositioGUI::consoleShown, this, &AppTests::consoleTests);
