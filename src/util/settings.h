...
#ifndef EXPOSITIO_UTIL_SETTINGS_H
#define EXPOSITIO_UTIL_SETTINGS_H
...
//!       https://github.com/expositio/expositio/pull/15934/files#r337691812)
...
#endif // EXPOSITIO_UTIL_SETTINGS_H
