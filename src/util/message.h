...
#ifndef EXPOSITIO_UTIL_MESSAGE_H
#define EXPOSITIO_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's expositio address, it must refer to a public key.
...
#endif // EXPOSITIO_UTIL_MESSAGE_H
