...
#ifndef EXPOSITIO_COMPAT_ASSUMPTIONS_H
#define EXPOSITIO_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Expositio cannot be compiled without assertions."
#endif
...
#endif // EXPOSITIO_COMPAT_ASSUMPTIONS_H
