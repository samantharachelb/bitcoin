...
static void SetupExpositioTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " expositio-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  expositio-tx [options] <hex-tx> [commands]  Update hex-encoded expositio transaction\n" +
            "or:     expositio-tx [options] -create [commands]   Create hex-encoded expositio transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded expositio transaction
